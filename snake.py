...
class Food:
    def __init__(self, FRAME_DIM,snakebod):
        self.snakebodies = snakebod
    ...
    def weedout(self):
        ...
        xval = random.randrange(xrange[0],xrange[len(xrange)-1],10)
        yval = random.randrange(yrange[0],yrange[len(yrange)-1],10)
